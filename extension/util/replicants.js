...
exports.autorecord = (0, nodecg_1.get)().Replicant('autorecord');
...
exports.fullScreenVideoPlayer = (0, nodecg_1.get)().Replicant('fullScreenVideoPlayer');
...
exports.lowerThird = (0, nodecg_1.get)().Replicant('lowerThird');
...
exports.soloedBidID = (0, nodecg_1.get)().Replicant('soloedBidID');
